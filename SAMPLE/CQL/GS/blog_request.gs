    ...
    )
{
    ...
    if ( IsAdministratorSession( request, &error_code )
         ...
         && GetRequestString( request, &section.Slug, "Slug", &error_code )
    ...
    )
{
    ...
    if ( IsAdministratorSession( request, &error_code )
         && GetRequestUuid( request, &article.SectionUuid, "SectionUuid", &error_code )
         && GetRequestUuid( request, &article.UserUuid, "UserUuid", &error_code )
         && GetRequestString( request, &article.Slug, "Slug", &error_code )
    ...
    )
{
    ...
    if ( IsAdministratorSession( request, &error_code )
         && GetRequestUuid( request, &comment.ArticleUuid, "ArticleUuid", &error_code )
