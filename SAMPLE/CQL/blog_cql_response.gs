    ...
    )
{
    ...
    WriteJsonUuid( response_writer, article.SectionId );
    WriteJsonText( response_writer, "\"UserId\":" );
    WriteJsonUuid( response_writer, article.UserId );
    ...
    )
{
    ...
    WriteJsonUuid( response_writer, comment.ArticleId );
    WriteJsonText( response_writer, "\"UserId\":" );
    WriteJsonUuid( response_writer, comment.UserId );
    WriteJsonText( response_writer, "\"Text\":" );
