    ...
    )
{
    ...
    router.Post( "/get_section_list", HandleGetSectionListRequest );
    ...
    router.Post( "/get_user_list", HandleGetUserListRequest );
    ...
    router.Post( "/get_article_list", HandleGetArticleListRequest );
    ...
    router.Post( "/get_comment_list", HandleGetCommentListRequest );
    ...
    router.Post( "/get_subscriber_list", HandleGetSubscriberListRequest );
}
