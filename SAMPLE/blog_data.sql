...
replace into `BLOG`.`USER`
    ...
    (
        ...
        "Megan",
        "Appleyard",
        "megan.appleyard@hotmail.com",
        "meganappleyard",
        "&Saur8erona",
        "+93 946 997 765",
        "65 Dambenieks Street",
        "Hagewood",
        "7732",
        "Mississippi",
        "Croatia",
...
replace into `BLOG`.`ARTICLE`
    ...
    (
        ...
        "4",
        "5",
        "Glittering now let a fiery red barabar hills.",
        "Diffused a grotto in death a seat and whirls the fervent prayer. Manhood rich had danced on sakwal boundless vault above. Though my latest breath will build upon the grass, unseen yet half divine may fall athwart our every prize. Indulge no thought a pompous rites had gone his way.",
        "oughadex.gif",
        "2002-12-15"
    );
...
replace into `BLOG`.`ARTICLE`
    ...
    (
        ...
        "2",
        "1",
        "Displaying lights from iran's plains were unknown.",
        "Beaming with shouting crowds that soon their prince, than araby the patient toil succeeds long farewell to wish, securely wrapped and shining by holy rishi had lost their sacred banks of gold. Quicker than light this grove where cruel castes and starved, tender all funeral train until at best were twain and happiness. Sending crystal clear stream now in widening ever near god their dying gaze. Breathing inward peace hail my lord and fester in deepest shadows darkened corners of himalaya's chain, go said with universal peace on life's early prime cut down from mind with prizes won.",
        "ektadevy.jpg",
        "2000-04-06"
    );
...
replace into `BLOG`.`ARTICLE`
    ...
    (
        ...
        "2",
        "5",
        "Rode mounted on passing breeze.",
        "Sword players keeping many hundreds grown to sing their dead before you were tinged by grain, named and drank deep ecstatic gaze of limb. Stirred these weary day heedless about his bones, deformed and lost when sadly raised hand that must be obeyed but some joys. Atair my fathers and colt of clanking chains of musicians coming first command. Preaching the summer nests by acts the gathered all funeral trains in rising sneer. Sole spot sweet harmony they seek and chief whose garments of opening spring, arriving home of such for rest and excelling every cottage came near. Myriads fled as the ripening fruits suited to grow that blissful heights. He sank exhausted on three horses long live beloved gold.",
        "eckenieb.gif",
        "2015-05-01"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "11",
        "1",
        "Onward and varied carpet velvet soft, called to realms of tenderness.",
        "2004-03-23 13:43:57"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "2",
        "4",
        "Kshatriyas warriors cruel creeds that tower. Along and grace saluting him low.",
        "2004-07-18 02:05:46"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "13",
        "2",
        "Ready champ their noisy mirth, its trials joys tempted to look behind. Beside the few words with flowers.",
        "2013-09-19 07:50:25"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "14",
        "3",
        "Surrounded by cool umbrageous groves. Only toil the river's bank. Upborne upon cyclopean columns vast. Without its joys of lesser strength.",
        "2004-01-26 03:50:53"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "13",
        "5",
        "Unnumbered stars spangle the wilds, saw her changes have given. Perhaps your wine is strong to guide, fear made his giddy mountain heights.",
        "2011-04-02 06:34:15"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "11",
        "5",
        "Snake charmers that selfishness so late appeared, darkening whole round gained clear celestial course. Soon despise what ails my funeral pile, fitter for sanctity had watched.",
        "2006-08-17 17:01:30"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "8",
        "2",
        "Waked by evil act and foul, whereat the prince was near. Marring its leaves carpeted his laggard pace.",
        "2007-07-28 09:01:30"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "15",
        "1",
        "Crushing the end or grasping greed, uprooting cherished evils one strong his arms. Trapusha one eternal law of care, acquiring sweetest notes soft eyed babes.",
        "2009-10-05 18:53:56"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "1",
        "1",
        "Bringing home with babbling brooks. Adorned by banks now direct your aid, wasting idleness the five who never thwart, has gone where heartless trade.",
        "2013-07-25 03:23:56"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "12",
        "1",
        "Great artificer himself must sleep. Scarce raised her sons cast aside, hallowed by death bravest men.",
        "2015-02-09 13:30:09"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "11",
        "2",
        "Were woven of soft as rahula lay, giving light galley leaves carpeted, rode alone from brahma god. Breathing sweet repose in paradise primordial peace.",
        "2009-06-11 19:21:50"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "15",
        "1",
        "Preserving recreating day has life explain, fade and ere brave watchful heart.",
        "2005-05-18 18:36:57"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "12",
        "5",
        "Willing world must answer purna's never blows. Well and earth his way, eagles scarce a passing night, curdled his prancing babylonians firmly held.",
        "2013-07-21 04:03:29"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "2",
        "5",
        "Without his fleshless skull had learned. Jugglers and poor people as bodies clothed, preaching the land to gain. Asked a cloud no after the park.",
        "2002-02-26 00:58:34"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "2",
        "1",
        "Receives him in filthy rags and castes, pause not whereon to changeless day.",
        "2001-09-11 12:55:39"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "15",
        "4",
        "Humble in worship now lost, not use a spreading shade, and creeds o bitter poisonous fruits.",
        "2013-09-14 16:05:04"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "10",
        "5",
        "Perennial from selfishness was cold bed, sparkling with flags flutter in smiles. Among the shouts from brightest hopes, live not master rose together smiled.",
        "2010-12-19 18:55:57"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "1",
        "4",
        "Leading rahula feel its grateful fragrance hang. Led by cares oppressed and brave men. Fair as rahula slept for others' good.",
        "2003-12-12 21:21:01"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "10",
        "2",
        "All secrets are quick to eye, lumbini called into quiet stood revealed, toward sailagiri hill and shake.",
        "2007-12-26 23:19:32"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "8",
        "3",
        "Bidding her pass with waking life size, another train escorted by night.",
        "2001-09-05 23:17:49"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "14",
        "3",
        "Perfect law of flying wheels by step. His kingdom gaze they go forth.",
        "2013-06-18 11:30:21"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "7",
        "4",
        "Cheering him all seeing eye, saluting him revisit his memory.",
        "2014-11-14 01:59:59"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "10",
        "2",
        "Clapping her youthful blood not herself, fathers loved me to foes. Stirred by trickling streams from hidden depths, adding each part of eternal perfect day.",
        "2000-08-27 12:33:52"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "13",
        "4",
        "Forever filling each other words describe. Their several arts and wretchedness and calm, sometimes while and trailing vines. Seeking bliss for now leaping in innocence.",
        "2015-08-11 16:08:25"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "15",
        "1",
        "This grotto cooled by power, swollen stream that pure unselfish love.",
        "2000-02-02 09:49:52"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "7",
        "2",
        "True forms concealed within above, ice bound snow by tartar steppes. Waved into the germ of gentleness, untaught as one deserted hearth.",
        "2000-06-06 06:41:53"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "4",
        "3",
        "Watering its gentleness and calmly said, passed since worn out quiet nook, night they searched in myriad stars.",
        "2003-03-03 19:35:26"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "10",
        "3",
        "Ewe necked ill fed his deeper skill, rising splendor now repeat the face away.",
        "2001-08-26 19:08:01"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "6",
        "3",
        "Dwell with distance with lavish hand. Parents and bleared and depths. Sleepless he bowed down from heaven, loading the devas hovered near.",
        "2010-04-09 20:32:08"
    );
...
replace into `BLOG`.`COMMENT`
    ...
    (
        ...
        "3",
        "4",
        "Blending the raging whirlwind flames, guiding each passing by countless ages grew.",
        "2007-04-27 14:18:54"
    );
